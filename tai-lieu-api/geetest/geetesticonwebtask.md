...
<figure><img src="../../.gitbook/assets/captcha_geetest_icon.png" alt=""><figcaption></figcaption></figure>
...
```json
{
    ...
    "task": {
        ...
        "anchorImageBase64s": ["BASE64_ICON_1", "BASE64_ICON_2", "BASE64_ICON_3"]
    }
}
```
