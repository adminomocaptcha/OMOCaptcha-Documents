...
<figure><img src="../../.gitbook/assets/image (29).png" alt=""><figcaption><p>2.Ảnh captcha reCAPTCHA-v2 Facebook</p></figcaption></figure>
...
```json
{
	"success": false,
	"status": "success",
	"result": "03AHJ_VuvYIBNBW5yyv0zRYJ75VkOKvhKj9_xGBJKnQim...."
}
```
